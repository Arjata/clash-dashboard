...
export declare const Filters: {
    ...
    getDefaultOptions: <TGenerics extends Partial<import("..").DefaultGenerics>>(instance: TableInstance<TGenerics>) => FiltersOptions<TGenerics>;
    createColumn: <TGenerics_1 extends Partial<import("..").DefaultGenerics>>(column: Column<TGenerics_1>, instance: TableInstance<TGenerics_1>) => FiltersColumn<TGenerics_1>;
    getInstance: <TGenerics_2 extends Partial<import("..").DefaultGenerics>>(instance: TableInstance<TGenerics_2>) => FiltersInstance<TGenerics_2>;
};
