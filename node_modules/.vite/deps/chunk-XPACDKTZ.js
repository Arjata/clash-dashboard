...
// node_modules/.pnpm/jotai@1.6.1_immer@9.0.12+react@18.0.0/node_modules/jotai/esm/index.js
...
var Provider = ({
  ...
  if ((import_meta.env && import_meta.env.MODE) !== "production" && (typeof process !== "object" || true)) {
...
function useSetAtom(atom2, scope) {
  ...
  const setAtom = (0, import_react.useCallback)((update) => {
    if (!("write" in atom2) && typeof process === "object" && true) {
...
//# sourceMappingURL=chunk-XPACDKTZ.js.map
