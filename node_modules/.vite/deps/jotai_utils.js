...
// node_modules/.pnpm/jotai@1.6.1_immer@9.0.12+react@18.0.0/node_modules/jotai/esm/utils.js
...
function useResetAtom(anAtom, scope) {
  ...
  const setAtom = (0, import_react.useCallback)(() => store[WRITE_ATOM](anAtom, RESET), [store, anAtom]);
  return setAtom;
}
...
function useAtomCallback(callback, scope) {
  const anAtom = (0, import_react.useMemo)(() => atom(null, (get, set, [arg, resolve, reject]) => {
    try {
  ...
  return (0, import_react.useCallback)((arg) => new Promise((resolve, reject) => {
...
var wrapResults = (atoms, results) => Array.isArray(atoms) ? results : Object.getOwnPropertyNames(atoms).reduce((out, key, idx) => __spreadProps$1(__spreadValues$1({}, out), { [key]: results[idx] }), {});
