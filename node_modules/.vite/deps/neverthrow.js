...
// node_modules/.pnpm/neverthrow@4.3.1/node_modules/neverthrow/dist/index.es.js
...
var combineResultListWithAllErrors = function(resultList) {
  return resultList.reduce(function(acc, result) {
    return result.isErr() ? acc.isErr() ? err(__spread(acc.error, [result.error])) : err([result.error]) : acc.isErr() ? acc : ok(__spread(acc.value, [result.value]));
  }, ok([]));
};
...
***************************************************************************** */
//# sourceMappingURL=neverthrow.js.map
